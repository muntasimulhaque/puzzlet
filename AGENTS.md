...
Known gaps (honest, not faked): store listing art beyond the launcher icon
(M3), the Play Console listing and first upload (M3), polish passes that
only play can reveal.
