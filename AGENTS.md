...
- The mark: the gather (the owner's pick from the icon-v4 candidate
  ...
  before the click. Four colours that are four colours, see D-052.
...
- D-052 The fourth piece is leaf green (owner-directed, and the owner's
  call against my whole redesign: keep the gather, change one colour).
  ...
  so the mark read as three colours and a repeat. It is `#6FB863` now,
  the leaf and mid-hill green the pictures already wear, the most used
  green in the scenes. Lesson: measure colour separation, do not eyeball
...
- The four colours in a mark are not four colours until they are measured.
...
- 2026-09-07: The owner's call on the mark: keep the gather, change one
  colour (D-052). The two yellows measured 12 deltaE apart, so the fourth
