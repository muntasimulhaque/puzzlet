...
language: warm paper, four chunky toy pieces, and
...
1. Pull the signed AAB from the `latest-build` GitHub release into the
   ...
   check ran green: CI build and capture both succeeded, the AAB in
   play-store/aab/ is versionCode 14, versionName 1.4, signed, awaiting
   the owner's upload; delete it from the folder after submitting.)
