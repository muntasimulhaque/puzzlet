...
class SoundGenTest {
    ...
    private val expectedMs = mapOf("sfx_snap" to 110, "sfx_tap" to 70, "sfx_chime" to 480)
    private val expectedPeak = mapOf("sfx_snap" to 0.70, "sfx_tap" to 0.70, "sfx_chime" to 0.70)
